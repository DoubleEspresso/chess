...
namespace {
  ...
  static const int square_scores[6][SQUARES] =
	...
	S(-5,5), S(-5,5), S(-5,5), S(10,5), S(10,5), S(-5,5), S(1-5,5), S(-5,5),
	S(-5,10), S(-5,10), S(10,10), S(30,25), S(30,25), S(10,10), S(-5,10), S(-5,10),
	...
	S(-10,-10), S(-10,-10), S(-10,-10), S(-10,-10), S(-10,-10), S(-10,-10), S(-10,-10), S(-10,-10)
      ...
      // white rooks
      {
	S(-20,0), S(-15,0), S(10,2), S(30,4), S(30,4), S(10,2), S(-15,0), S(-20,0),
	S(-10,0), S(-10,0), S(5,2), S(6,4), S(6,4), S(5,2), S(-10,0), S(-10,0),
	S(0,0), S(0,0), S(5,2), S(10,4), S(10,4), S(5,2), S(0,0), S(0,0),
