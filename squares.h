...
namespace {
  ...
  /*
  template<Color c, Piece p> inline int square_score(int phase, int square) {
    if (c == BLACK) square = 56 - 8 * ROW(square) + COL(square);
    return square_scores2[phase][p][square];
  }
  */
  template<BLACK, Piece p> inline int square_score(int phase, int square) {
    return square_scores2[phase][p][56 - 8 * ROW(square) + COL(square)];
  }

  template<WHITE, Piece p> inline int square_score(int phase, int square) {
    return square_scores2[phase][p][square];
  }
